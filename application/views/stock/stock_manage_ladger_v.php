...
<section class="dashbord stock_manage">
   ...
   <button type="submit" class="btn btn-primary acontview"><a href="<?php echo base_url('stock/addstock/'.$this->uri->segment('3'))?>">Add Stock</a></button>
<!--table start here-->
<table id="example" class="table table-responsive ">
  ...
  <?php
    ...
    foreach ($stock_info as $v_stock_info) { 
        //print_r($v_stock_info->item_name);
  ?>
    <tr class="rocolor1">
      ...
      <button type="submit" class="btn btn-primary acontview"><a href="<?php echo base_url('stock/edit_stock_l/'.$v_stock_info['id'])?>">Edit</a></button>
...
<div id="viewModal<?php echo $v_stock_info['id']?>" class="modal fade" role="dialog" aria-hidden="true" style="display: none;">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      <p><span style="font-weight:500;">Bill No.</span>:-  <?php echo $v_stock_info['bill_no']; ?></p>
